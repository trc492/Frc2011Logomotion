 ...
 * TrcPIDDrive object is going to combine two PID controllers to calculate
 * the drive output. One PID controller is for driving straight distance and
 * the other is for turning. In addition, the WPI PIDController is creating
 * a periodic loop per controller. In the TRC library, we will do periodic
 * loop at a higher level in the TrcPIDDrive object instead.
 */
class TrcPIDCtrl
{
private:
...
public:
     ...
     * previous error is within target tolerance.
     *
